...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("spring.security.api"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .version("1.0.0")
                .contact(new Contact("Malinga (github)", "https://github.com/Malinga-hub/springboot-mongodb-jwt-api-template", "Malinga.simcuhimba@gmail.com"))
                .build();
    }
